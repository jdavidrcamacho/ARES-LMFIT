# -*- coding: utf-8 -*-
"""
Created on Tue Jul  5 15:59:12 2016
...
data= np.loadtxt('tmp_4531_62.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<4530.380)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<4531.980)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.01, 4530.48, 0.05, \
            -0.15, 4530.74, 0.08, \
            -0.08, 4530.96, 0.05, \
            -0.1, 4531.17, 0.05, \
            -0.07, 4531.64, 0.05,\
            -0.008, 4531.90, 0.05]
constrains = [(-0.02,-0.005), (4530.45,4530.50), (0.06,0.04), \
                (-0.18,-0.12), (4530.70,4530.75), (0.1,0.07), \
                (-0.1,-0.07), (4530.95,4531.00), (0.08,0.02), \
                (-0.12,-0.08), (4531.15,4531.20), (0.08,0.02), \
                (-0.08,-0.06), (4531.60,4531.65), (0.08,0.02), \
                (-0.01,-0.004), (4531.85,4531.95), (0.06,0.04)]
