# -*- coding: utf-8 -*-
"""
Created on Wed Jun 29 11:05:54 2016
...
data= np.loadtxt('tmp_6005_56.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6005.271)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6005.671)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.035, 6005.56, 0.05]
constrains = [(-0.05,-0.03), (6005.50,6005.65), (0.03,0.06)]
