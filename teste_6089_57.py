# -*- coding: utf-8 -*-
"""
Created on Mon Jul  4 12:11:59 2016
...
data= np.loadtxt('tmp_6089_57.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6089.390)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6089.750)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.05, 6089.58, 0.055]
constrains = [(-0.06,-0.035), (6089.55,6089.60), (0.07,0.03)]
