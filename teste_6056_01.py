# -*- coding: utf-8 -*-
"""
Created on Wed Jun 29 12:04:39 2016
...
data= np.loadtxt('tmp_6056_01.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6055.780)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6056.660)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.08, 6056.01, 0.1, \
            -0.05,6056.35, 0.1]
constrains = [(-0.10,-0.07), (6055.00,6056.05), (0.03,0.06),\
                (-0.01,-0.001), (6056.30,6056.40), (0.15,0.05)]
