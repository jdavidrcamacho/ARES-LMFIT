# -*- coding: utf-8 -*-
"""
Created on Wed Apr 20 22:34:04 2016
...
data= np.loadtxt('tmp_4534_17.txt',dtype=None)
...
a0=np.where(x<4533.510)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<4534.330)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.20, 4533.98, 0.12, \
            -0.02, 4534.18, 0.03]
constrains = [(-0.25,-0.15), (4533.95,4534.0), (0.01,0.2), \
                (-0.03,-0.01), (4534.15,4534.20), (0.02,0.04)]
#yfinal=yfinal+1                
