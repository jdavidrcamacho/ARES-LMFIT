# -*- coding: utf-8 -*-
"""
Created on Tue Jul  5 15:32:18 2016
...
data= np.loadtxt('tmp_4523_40.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<4522.261)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<4523.521)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.001, 4522.37, 0.05, \
            -0.01, 4522.53, 0.08, \
            -0.17, 4522.65, 0.08, \
            -0.08, 4522.81, 0.05, \
            -0.025, 4523.08, 0.05,\
            -0.045, 4523.41, 0.045]
constrains = [(-0.002,-0.0009), (4522.35,4522.40), (0.06,0.04), \
                (-0.02,-0.005), (4522.50,4522.55), (0.1,0.07), \
                (-0.2,-0.15), (4522.60,4522.70), (0.1,0.07), \
                (-0.10,-0.07), (4522.80,4522.85), (0.08,0.02), \
                (-0.04,-0.02), (4523.05,4523.10), (0.08,0.02), \
                (-0.05,-0.040), (4523.40,4523.45), (0.08,0.02)]
