# -*- coding: utf-8 -*-
"""
Created on Sat Jul  2 15:05:03 2016
...
data= np.loadtxt('tmp_5522_45.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<5522.281)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<5522.601)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.05,5522.46, 0.05]
constrains = [(-0.6,-0.04), (5522.45,5522.50), (0.03,0.06)]
