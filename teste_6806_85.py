# -*- coding: utf-8 -*-
"""
Created on Mon May  5 19:35:38 2016
...
data= np.loadtxt('tmp_6806_85.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6806.695)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6807.025)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.01, 6806.85, 0.045]
constrains = [(-.1,-0.02), (6806.80,6806.90), (0.03,0.06)]
