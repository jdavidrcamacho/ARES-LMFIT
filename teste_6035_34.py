# -*- coding: utf-8 -*-
"""
Created on Wed Jun 29 11:20:59 2016
...
data= np.loadtxt('tmp_6035_34.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6035.231)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6035.451)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.0035,6035.35, 0.03]
constrains = [(-0.005,-0.001), (6035.30,6035.40), (0.03,0.4)]
