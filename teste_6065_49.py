# -*- coding: utf-8 -*-
"""
Created on Wed May 20 18:37:31 2016
...
data= np.loadtxt('tmp_6065_49.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6065.060)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6065.860)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.12, 6065.51, 0.06]
constrains = [(-0.15,-0.1), (6065.48,6065.53), (0.04,0.07)]
