...
data= np.loadtxt('tmp_6149_25.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6148.918)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6149.398)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.06, 6149.25, 0.075]
constrains = [(-0.1,-0.04), (6149.20,6149.30), (0.06,0.09)]
