# -*- coding: utf-8 -*-
"""
Created on Wed Jun  8 12:08:16 2016
...
data= np.loadtxt('tmp_6315_81.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6315.605)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6315.985)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.04, 6315.82, 0.055]
constrains = [(-0.05,-0.03), (6315.80,6315.85), (0.03,0.06)]
