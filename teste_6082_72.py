# -*- coding: utf-8 -*-
"""
Created on Mon Jul  4 11:28:41 2016
...
data= np.loadtxt('tmp_6082_72.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6082.250)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6082.850)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.01, 6082.44, 0.07, \
            -0.05, 6082.73, 0.07]
constrains = [(-0.2,-0.009), (6082.40,6082.45), (0.08,0.05), \
                (-0.6,-0.04), (6082.70,6082.75), (0.08,0.05)]
