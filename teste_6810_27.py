# -*- coding: utf-8 -*-
"""
Created on Tue May 20 21:13:27 2016
...
data= np.loadtxt('tmp_6810_27.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6810.025)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6810.445)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.03, 6810.27, 0.045]
constrains = [(-.01,-0.05), (6810.25,6810.30), (0.03,0.06)]
