# -*- coding: utf-8 -*-
"""
Created on Tue May 22 14:18:11 2016
...
data= np.loadtxt('tmp_5635_83.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<5635.689)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<5635.969)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.04, 5635.83, 0.03]
constrains = [(-0.06,-0.03), (5635.8,5635.85), (0.01,0.04)]
