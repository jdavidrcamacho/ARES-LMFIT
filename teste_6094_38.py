# -*- coding: utf-8 -*-
"""
Created on Mon Jul  4 12:33:15 2016
...
data= np.loadtxt('tmp_6094_38.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6094.169)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6094.579)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.03, 6094.39, 0.065]
constrains = [(-0.05,-0.02), (6094.35,6094.40), (0.07,0.05)]
