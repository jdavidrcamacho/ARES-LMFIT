# -*- coding: utf-8 -*-
"""
Created on Mon Jul  4 12:42:07 2016
...
data= np.loadtxt('tmp_6098_25.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6098.119)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6098.459)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.021, 6098.26, 0.065]
constrains = [(-0.022,-0.019), (6098.24,6098.30), (0.07,0.050)]
