# -*- coding: utf-8 -*-
"""
Created on Wed Jun  8 11:31:46 2016
...
data= np.loadtxt('tmp_6820_37.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6820.125)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6820.565)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.035, 6820.39, 0.05]
constrains = [(-0.05,-0.03), (6820.35,6820.40), (0.03,0.06)]
