# -*- coding: utf-8 -*-
"""
Created on Mon Jun  5 11:16:15 2016
...
data= np.loadtxt('tmp_6180_21.txt',dtype=None)
...
a0=np.where(x<6179.888)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6180.558)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.005, 6179.98, 0.05, \
        -0.08, 6180.22, 0.08]
constrains = [(-0.007,-0.004), (6179.95,6180.00), (0.03,0.07), \
            (-0.09,-0.05), (6180.20,6180.25), (0.07,0.1)]
#yfinal=yfinal+1                
