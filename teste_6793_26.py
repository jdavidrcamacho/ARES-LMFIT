# -*- coding: utf-8 -*-
"""
Created on Mon Jun  6 10:39:01 2016
...
data= np.loadtxt('tmp_6793_26.txt',dtype=None)
...
a0=np.where(x<6793.116)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6793.406)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.012, 6793.28, 0.05]
constrains = [(-0.015,-0.008), (6793.25,6793.30), (0.03,0.07)]
#yfinal=yfinal+1                
