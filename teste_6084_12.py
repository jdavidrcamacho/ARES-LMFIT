# -*- coding: utf-8 -*-
"""
Created on Mon Jul  4 12:06:51 2016
...
data= np.loadtxt('tmp_6084_12.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6083.980)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6084.260)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.024, 6084.12, 0.05]
constrains = [(-0.03,-0.02), (6084.10,6084.15), (0.06,0.03)]
