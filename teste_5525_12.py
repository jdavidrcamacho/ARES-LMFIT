# -*- coding: utf-8 -*-
"""
Created on Sat Jul  2 15:13:23 2016
...
data= np.loadtxt('tmp_5525_12.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<5524.891)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<5525.221)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.005, 5524.97, 0.06, \
            -0.015, 5525.13, 0.06]
constrains = [(-0.01,-0.001), (5524.95,5525.00), (0.07,0.05),\
                (-0.02,-0.005), (5525.10,5525.15), (0.07,0.05)]
