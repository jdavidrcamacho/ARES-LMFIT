# -*- coding: utf-8 -*-
"""
Created on Mon Jul  4 14:59:47 2016
...
data= np.loadtxt('tmp_6416_93.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6416.773)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6417.123)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.05, 6416.94, 0.065]
constrains = [(-0.07,-0.04), (6416.90,6416.95), (0.08,0.06)]
