# -*- coding: utf-8 -*-
"""
Created on Fri Jul  1 15:29:19 2016
...
data= np.loadtxt('tmp_5141_76.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<5141.528)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<5141.998)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.12, 5141.76, 0.075]
constrains = [(-0.2,-0.095), (5141.70,5141.80), (0.02,0.10)]
