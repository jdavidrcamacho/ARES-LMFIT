# -*- coding: utf-8 -*-
"""
Created on Mon Jul  4 12:38:37 2016
...
data= np.loadtxt('tmp_6096_67.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6096.459)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6096.829)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.05, 6096.68, 0.065]
constrains = [(-0.07,-0.04), (6096.65,6096.70), (0.07,0.05)]
