# -*- coding: utf-8 -*-
"""
Created on Wed Jun 29 15:03:50 2016
...
data= np.loadtxt('tmp_6120_25.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6120.149)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6120.349)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.004, 6120.25, 0.03]
constrains = [(-0.005,-0.00301), (6120.20,6120.30), (0.01,0.035)]
