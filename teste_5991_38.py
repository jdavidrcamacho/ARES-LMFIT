# -*- coding: utf-8 -*-
"""
Created on Sat Jul  2 16:17:45 2016
...
data= np.loadtxt('tmp_5991_38.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<5991.141)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<5991.511)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.005, 5991.23, 0.05, \
            -0.05, 5991.38, 0.05]
constrains = [(-0.01,-0.003), (5991.20,5991.25), (0.07,0.04),\
                (-0.06,-0.03), (5991.35,5991.40), (0.07,0.04)]
