# -*- coding: utf-8 -*-
"""
Created on Wed Jul  6 12:28:34 2016
...
data= np.loadtxt('tmp_5225_53.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<5225.377)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<5227.807)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.085, 5226.54, 0.05, \
            ...
            -0.21, 5227.22, 0.095,\
            -0.008, 5227.74, 0.05]
constrains = [(-0.1,-0.08), (5226.55,5226.60), (0.08,0.02), \
                (-0.02,-0.005), (5225.80,5225.85), (0.08,0.02), \
                (-0.02,-0.005), (5226.05,5226.10), (0.1,0.07), \
                (-0.02,-0.005), (5226.15,5226.25), (0.1,0.07), \
                
                (-0.05,-0.01), (5226.55,5226.60), (0.08,0.02), \
                (-0.20,-0.16), (5226.85,5226.90), (0.08,0.06), \
                (-0.22,-0.20), (5227.20,5227.25), (0.1,0.09), \
                (-0.01,-0.006), (5227.70,5227.75), (0.06,0.04)]
