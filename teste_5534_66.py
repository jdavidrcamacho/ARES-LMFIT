# -*- coding: utf-8 -*-
"""
Created on Sat Jul  2 15:21:32 2016
...
data= np.loadtxt('tmp_5534_66.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<5534.541)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<5535.001)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.01, 5534.67, 0.06, \
            -0.075, 5534.86, 0.06]
constrains = [(-0.02,-0.009), (5534.65,5534.70), (0.07,0.05),\
                (-0.8,-0.07), (5534.85,5534.90), (0.07,0.05)]
