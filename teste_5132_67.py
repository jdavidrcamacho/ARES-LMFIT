# -*- coding: utf-8 -*-
"""
Created on Fri Jul  1 14:57:38 2016
...
data= np.loadtxt('tmp_5132_67.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<5132.258)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<5132.818)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.01, 5132.36, 0.05, \
            -0.005, 5132.51, 0.1, \
            -0.045, 5132.68, 0.08]
constrains = [(-0.02,-0.005), (5132.35,5132.40), (0.03,0.06),\
                (-0.02,-0.005), (5132.50,5132.55), (0.11,0.08),\
                (-0.1,-0.01), (5132.65,5132.70), (0.15,0.05)]
