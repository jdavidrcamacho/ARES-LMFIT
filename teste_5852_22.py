# -*- coding: utf-8 -*-
"""
Created on Tue May 22 15:27:30 2016
...
data= np.loadtxt('tmp_5852_22.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<5852.014)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<5852.404)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.04, 5852.23, 0.04]
constrains = [(-0.05,-0.03), (5852.20,5852.25), (0.03,0.05)]
