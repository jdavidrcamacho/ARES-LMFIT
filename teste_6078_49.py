# -*- coding: utf-8 -*-
"""
Created on Mon Jul  4 11:09:04 2016
...
data= np.loadtxt('tmp_6078_49.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6078.200)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6078.750)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.085, 6078.51, 0.065]
constrains = [(-0.10,-0.065), (6078.47,6078.53), (0.07,0.03)]
