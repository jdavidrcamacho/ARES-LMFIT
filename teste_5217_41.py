# -*- coding: utf-8 -*-
"""
Created on Wed Jul  6 12:15:39 2016
...
data= np.loadtxt('tmp_5217_40.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<5217.097)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<5217.657)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.13, 5217.41, 0.068]
constrains = [(-0.15,-0.12), (5217.40,5217.45), (0.0758,0.060)]
