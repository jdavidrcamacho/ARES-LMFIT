# -*- coding: utf-8 -*-
"""
Created on Mon Jul  4 15:08:03 2016
...
data= np.loadtxt('tmp_6407_29.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6406.953)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6408.833)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.003, 6407.07, 0.03, \
            ...
            -0.007, 6408.68, 0.06, \
            -0.0001, 6408.82, 0.01]
constrains = [(-0.005,-0.001), (6407.05,6407.10), (0.04,0.02), \
                (-0.05,-0.02), (6407.25,6407.35), (0.08,0.06), \
                (-0.06,-0.01), (6407.65,6407.75), (0.8,0.1), \
                (-0.12,-0.08), (6408.05,6408.10), (0.08,0.06), \
                (-0.01,-0.004), (6408.35,6408.40), (0.08,0.05), \
                (-0.01,-0.005), (6408.65,6408.70), (0.08,0.05), \
                (-0.0002,-0.0005), (6408.80,6408.85), (0.02,0.005)]
