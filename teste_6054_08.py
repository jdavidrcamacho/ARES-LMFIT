# -*- coding: utf-8 -*-
"""
Created on Wed Jun 29 11:54:02 2016
...
data= np.loadtxt('tmp_6054_08.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6053.940)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6054.190)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.01, 6054.08, 0.05]
constrains = [(-0.03,-0.009), (6054.00,6054.10), (0.03,0.06)]
