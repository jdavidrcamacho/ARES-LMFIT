# -*- coding: utf-8 -*-
"""
Created on Wed Jun 29 15:30:01 2016
...
data= np.loadtxt('tmp_6127_91.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6127.739)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6128.279)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.07, 6127.92, 0.1, \
            -0.04,6128.15, 0.1]
constrains = [(-0.10,-0.05), (6127.90,6127.95), (0.03,0.06),\
                (-0.03,-0.001), (6128.10,6128.20), (0.15,0.05)]
