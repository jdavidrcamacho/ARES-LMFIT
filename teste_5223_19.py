# -*- coding: utf-8 -*-
"""
Created on Wed Jul  6 12:19:58 2016
...
data= np.loadtxt('tmp_5223_19.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<5223.057)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<5223.317)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.035, 5223.19, 0.045]
constrains = [(-0.4,-0.033), (5223.15,5223.20), (0.06,0.04)]
