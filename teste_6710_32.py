# -*- coding: utf-8 -*-
"""
Created on Sat Jul  2 16:44:18 2016
...
data= np.loadtxt('tmp_6710_32.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<6710.197)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<6710.497)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.02, 6710.33, 0.045]
constrains = [(-0.05,-0.01), (6710.30,6710.35), (0.07,0.03)]
