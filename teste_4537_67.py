# -*- coding: utf-8 -*-
"""
Created on Thu Apr 21 14:22:33 2016
...
data= np.loadtxt('tmp_4537_67.txt',dtype=None)
y=data[:,1]
x=data[:,0]
#figure()
...
a0=np.where(x<4537.560)
a1=list(a0[-1])
a2=a1[-1]
b0=np.where(x<4538.260)
b1=list(b0[-1])
b2=b1[-1]
#corte
xfinal=x ;yfinal=y
...
params = [-0.04, 4537.67, 0.05, \
             -0.015, 4537.97, 0.1]
constrains = [(-0.05,-0.01), (4537.8,4537.5), (0.01,0.5), \
                (-0.02,-0.01), (4537.8,4538.1), (0.05,0.2)]
...
###############################################################################
#LIMITS SPECTRA FOR FIT: lli: 4537.560 -- llf: 4538.260 
